...
(1, 2, N'iPhone 15',        25000000, 27000000, 50, N'Điện thoại Apple mới nhất', N'iphone15.png'),
(1, 2, N'Samsung Galaxy S23', 20000000, 22000000, 40, N'Điện thoại Samsung flagship', N's23.png'),
(1, 3, N'MacBook Pro 14',   45000000, 48000000, 20, N'Laptop Apple cao cấp', N'macbook14.png'),
(1, 3, N'Dell XPS 13',      30000000, 32000000, 25, N'Laptop Dell mỏng nhẹ', N'dellxps.png'),
(2, 5, N'Áo sơ mi nam',        500000,   600000, 100, N'Áo sơ mi công sở', N'aosomi.png'),
(2, 6, N'Váy công chúa',       700000,   850000, 80, N'Váy cho nữ', N'/vay.png'),
(2, 7, N'Giày sneaker',       1200000,  1500000, 60, N'Giày thể thao trẻ trung', N'sneaker.png'),
(2, 5, N'Quần jeans nam',      800000,   950000, 90, N'Quần jeans bền đẹp', N'jeans.png'),
(2, 6, N'Áo khoác nữ',         900000,  1100000, 70, N'Áo khoác mùa đông', N'aokhoac.png'),
(2, 7, N'Dép sandal',          300000,   400000, 50, N'Dép sandal tiện lợi', N'sandal.png'),
(3, 8, N'Nồi cơm điện 1.8L', 1200000, 1500000, 30, N'Nồi cơm điện cao cấp, tiết kiệm điện', N'noicom.png'),
(3, 9, N'Bộ dao nhà bếp', 500000, 700000, 50, N'Bộ dao inox Nhật Bản sắc bén', N'dao.png'),
(3, 10, N'Bàn trà gỗ sồi', 2500000, 3000000, 15, N'Bàn trà phòng khách gỗ sồi tự nhiên', N'bantra.png'),
(3, 8, N'Máy hút bụi mini', 1800000, 2200000, 20, N'Máy hút bụi mini cầm tay', N'mayhutbui.png'),
(4, 4, N'Son môi cao cấp', 350000, 450000, 100, N'Son môi lâu trôi, màu sắc tự nhiên', N'son.png'),
(4, 4, N'Kem dưỡng da ban đêm', 600000, 750000, 80, N'Kem dưỡng trắng và dưỡng ẩm', N'kem.png'),
(4, 4, N'Sữa rửa mặt thiên nhiên', 200000, 250000, 120, N'Sữa rửa mặt chiết xuất trà xanh', N'suaruamat.png'),
(4, 4, N'Nước hoa hồng', 400000, 500000, 90, N'Toner dưỡng ẩm, se khít lỗ chân lông', N'nuochoahong.png'),
(5, 8, N'Gạo ST25', 25000, 30000, 200, N'Gạo ngon nhất thế giới, hạt dài, dẻo thơm', N'gao.png'),
(5, 8, N'Nước mắm Phú Quốc', 70000, 90000, 150, N'Nước mắm truyền thống Phú Quốc 40 độ đạm', N'nuocmam.png'),
(5, 8, N'Trái cây sấy mix', 120000, 150000, 100, N'Hộp trái cây sấy dinh dưỡng', N'traicaysay.png'),
(5, 8, N'Cà phê hạt rang xay', 180000, 220000, 80, N'Cà phê hạt nguyên chất Buôn Ma Thuột', N'caphe.png');
...
-- 9. DELIVERIES
--------------------------------------------------------
INSERT INTO deliveries (shipper_id, order_id, status, created_at)
VALUES
(1, 1,  N'Đã gán',   '2025-01-05 09:15:00'),
(1, 2,  N'Đang giao', '2025-01-10 14:30:00'),
(2, 3,  N'Đã giao',   '2025-01-15 16:45:00'),
(2, 4,  N'Đang giao', '2025-01-20 10:00:00'),
(1, 5,  N'Đã gán',    '2025-02-01 08:20:00'),
(2, 6,  N'Đã giao',   '2025-02-10 11:10:00'),
(1, 7,  N'Đã giao',   '2025-02-15 13:40:00'),
(1, 8,  N'Đã gán',    '2025-03-01 09:05:00'),
(2, 9,  N'Đang giao', '2025-03-10 15:25:00'),
(2, 10, N'Đã giao',   '2025-03-20 17:50:00');
