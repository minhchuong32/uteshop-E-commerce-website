...
<div class="container py-4">
    ...
    <!-- 🧭 Bộ lọc -->
    <form action="${pageContext.request.contextPath}/web/shop/detail" method="get" class="row g-3 align-items-end mb-4">
        ...
        <div class="col-md-3 d-flex gap-2">
            ...
            <a href="${pageContext.request.contextPath}/web/shop/detail?id=${shop.shopId}" class="btn btn-outline-secondary w-50">Xóa lọc</a>
        </div>
    </form>
            ...
            <ul class="pagination justify-content-center">
                <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                    <a class="page-link nav-link"
                       href="${pageContext.request.contextPath}/web/shop/detail?id=${shop.shopId}&page=${currentPage - 1}">Trước</a>
                </li>
                <c:forEach var="i" begin="1" end="${totalPages}">
                    <li class="page-item ${i == currentPage ? 'active' : ''}">
                        <a class="page-link nav-link ${i == currentPage ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/web/shop/detail?id=${shop.shopId}&page=${i}">${i}</a>
                    </li>
                </c:forEach>
                <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                    <a class="page-link nav-link"
                       href="${pageContext.request.contextPath}/web/shop/detail?id=${shop.shopId}&page=${currentPage + 1}">Sau</a>
                </li>
            </ul>
        </nav>
    </c:if>
