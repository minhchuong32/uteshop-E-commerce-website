	...
	<form action="${pageContext.request.contextPath}/admin/products/add"
		...
		<div class="mb-3">
			<label class="form-label fw-semibold">Tên sản phẩm</label> <input
				required type="text" name="name" class="form-control" required>
		</div>
		...
		<div class="mb-4 text-center">
			<label class="form-label fw-semibold d-block">Ảnh sản phẩm
				chính</label> <img id="mainImagePreview"
				src="${pageContext.request.contextPath}/assets/images/products/default-product.jpg"
				class="border rounded mb-2 shadow-sm" width="160" height="160"
		...
		<table id="variantTable"
			...
			<tbody>
				<tr>
					<td><input required type="text" name="optionName" class="form-control"
						placeholder="VD: Màu sắc"></td>
					<td><input required type="text" name="optionValue" class="form-control"
						placeholder="VD: Đỏ"></td>
					<td><input required type="number"  min="0" step="0.01" name="price"
						class="form-control"></td>
					<td><input required type="number"  min="0" step="0.01" name="oldPrice"
						class="form-control"></td>
					<td><input type="number" name="stock"  min="0" step = "1" class="form-control"></td>
					<td class="text-center"><img
						...
						accept="image/*" onchange="previewVariantImage(this)"></td>
		...
		<div class="d-flex justify-content-between mt-4">
			...
			<button type="submit" class="btn btn-primary-custom">Lưu sản
				phẩm</button>
		</div>
	</form>
</div>
