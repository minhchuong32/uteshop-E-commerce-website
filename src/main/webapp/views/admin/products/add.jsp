...
<div class="container-fluid">
	...
	<form action="${pageContext.request.contextPath}/admin/products/add"
		...
		<div class="mb-3 text-center">
			<label class="form-label fw-semibold d-block">Hình ảnh sản phẩm</label>
			<input type="file" name="imageUrl" class="form-control w-auto mx-auto"
		...
		<div class="d-flex justify-content-between mt-4">
			<a href="${pageContext.request.contextPath}/admin/products"
			   class="btn btn-outline-primary-custom rounded-pill px-4">
			   Quay lại
			</a>
