...
<div class="container-fluid px-4">
	...
	<div class="card shadow-sm border-0">
		<div class="card-header bg-primary-custom">
			<h4 class="mb-0 text-white"><i class="bi bi-person-plus-fill me-2"></i>Thêm người dùng mới</h4>
		</div>
				...
				<div class="row">
					...
					<div class="col-lg-8">
						<div class="row">
							...
							<div class="col-md-6 mb-3">
								<label for="name" class="form-label fw-bold">Tên hiển thị</label>
								<input type="text" id="name" name="name" class="form-control" placeholder="Ví dụ: Nguyễn Văn A" required />
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 mb-3">
						...
						<div class="mb-3">
							...
							<input type="text" id="phone" name="phone" class="form-control" placeholder="Ví dụ: 0901234567" />
						</div>
						<div class="mb-3">
							<label for="address" class="form-label fw-bold">Địa chỉ</label>
							<input type="text" id="address" name="address" class="form-control" placeholder="Nhập địa chỉ cư trú" />
						</div>
						<div class="mb-3">
