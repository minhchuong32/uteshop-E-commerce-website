...
<div class="container-fluid px-4">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-primary-custom">
            <h4 class="mb-0 text-white"><i class="bi bi-envelope-paper-fill me-2"></i>Quản lý Liên hệ</h4>
        </div>
                    ...
                    <tbody>
                        <c:forEach items="${contacts}" var="contact" varStatus="loop">
                            <tr>
                                ...
                                <td style="max-width: 350px; white-space: pre-wrap; word-break: break-word;">
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        <%-- Nút phản hồi --%>
                                        <a href="${pageContext.request.contextPath}/admin/contacts/reply?id=${contact.contactId}" class="btn btn-outline-primary" title="Phản hồi">
                        ...
                        <c:if test="${empty contacts}">
							<tr>
								<td colspan="6" class="text-center text-muted py-4">Chưa có liên hệ nào.</td>
							</tr>
						</c:if>
                    </tbody>
                </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content shadow">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLabel"><i class="bi bi-exclamation-triangle text-danger me-2"></i>Xác nhận Xóa</h5>
