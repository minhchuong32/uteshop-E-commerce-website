    ...
    <div class="card shadow-sm flex-fill h-100">
      <div class="card-body d-flex flex-column">
        ...
        <div class="mt-2 text-muted small">
          ...
          %: ${percentCount} CT, TB: 
          <fmt:formatNumber value="${avgPercent}" pattern="#,##0.##"/>%<br>
          ₫: ${fixedCount} CT, TB: 
          <fmt:formatNumber value="${avgFixed}" type="currency" currencySymbol="₫"/>
        </div>
      </div>
    </div>
  </div>
...
<div class="text-end mb-3">
  <a href="${pageContext.request.contextPath}/admin/promotions/add" class="btn btn-success">
      ...
      <tbody>
        <c:forEach var="p" items="${promotions}">
          <tr>
            ...
            <td>${p.shop.name}</td>
            <td>
              <span class="badge ${p.discountType eq 'percent' ? 'bg-info' : 'bg-success'}">
            ...
            <td class="text-center">
              <a href="${pageContext.request.contextPath}/admin/promotions/edit?id=${p.promotionId}" 
...
<div class="modal fade" id="confirmDeleteModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 shadow-lg rounded-3">
      ...
      <div class="modal-body">Bạn có chắc muốn xóa khuyến mãi này không?<br><strong>Hành động này không thể hoàn tác.</strong></div>
      <div class="modal-footer">
        <button class="btn btn-outline-secondary" data-bs-dismiss="modal">Hủy</button>
        <a id="deleteConfirmBtn" href="#" class="btn btn-danger"><i class="bi bi-trash-fill me-1"></i> Xóa</a>
      </div>
    </div>
  </div>
</div>
