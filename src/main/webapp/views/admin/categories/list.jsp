				...
				<tbody>
					<c:forEach var="c" items="${categories}" varStatus="loop">
						<tr>
							...
							<td class="text-center">
								<span class="badge bg-info text-dark">${c.products.size()} SP</span>
							</td>
							<td class="text-center">
								<!-- Edit -->
								<a href="${pageContext.request.contextPath}/admin/categories/edit?id=${c.categoryId}"
								   class="text-warning me-3" title="Sửa danh mục">
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content shadow-lg border-0 rounded-3">
			...
			<div class="modal-body">
				<p>Bạn có chắc muốn xóa danh mục này không? <strong>Hành động này không thể hoàn tác!</strong></p>
			</div>
