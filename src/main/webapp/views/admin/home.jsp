					...
					<c:forEach var="c" items="${categories}" varStatus="status">
						<c:if test="${status.index < 12}">
							<div class="col-2 category-card border rounded">
								<a
									href="${pageContext.request.contextPath}/admin/products?categoryId=${c.categoryId}"
			...
			<div class="row g-3" id="gridView">
				<c:forEach var="p" items="${products}">
					...
					<div class="col-6 col-md-4 col-lg-2">
						<a
							href="${pageContext.request.contextPath}/admin/product/detail?id=${p.productId}"
							...
							<div class="card product-card h-100">
								...
								<div
									...
									<button type="button"
										...
										onclick="window.location.href='${pageContext.request.contextPath}/admin/product/detail?id=${p.productId}'">
				...
				<nav aria-label="Page navigation" class="mt-4">
					<ul class="pagination justify-content-center">
						...
						<li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
							...
							href="${pageContext.request.contextPath}/admin/home?page=${currentPage - 1}">
								Trước </a>
						</li>
						<!-- Các số trang -->
						<c:forEach var="i" begin="1" end="${totalPages}">
							<li class="page-item ${i == currentPage ? 'active' : ''}"><a
								...
								href="${pageContext.request.contextPath}/admin/home?page=${i}">
									${i} </a></li>
						</c:forEach>
						<!-- Nút Next -->
						<li
