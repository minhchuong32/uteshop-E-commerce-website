...
<h3 class="mb-4 text-center text-primary fw-bold">
    <i class="bi bi-bell-fill me-2"></i>Thông báo của shipper
</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="collapse mt-3 border-top pt-3" id="collapse${n.id}">
                        ...
                        <c:if test="${n.relatedComplaint != null}">
                            <div class="mt-3">
                                <p><strong>Khiếu nại giao hàng:</strong> ${n.relatedComplaint.title}</p>
                                <p>${n.relatedComplaint.content}</p>
                                <a href="${pageContext.request.contextPath}/shipper/chat?complaintId=${n.relatedComplaint.complaintId}"
...
<div class="text-center mt-4">
    <a href="${pageContext.request.contextPath}/shipper/home" class="btn btn-outline-secondary">
