								...
								<c:choose>
									<c:when
										...
										<p class="text-muted mb-0"
											...
											<fmt:formatNumber value="${variant.oldPrice}" type="currency"
												currencySymbol="₫" />
										</p>
...
<button id="chatbot-toggler" class="support-widget">
	<i class="bi bi-chat-dots"></i>
</button>

<button id="s" class="support-widget" type="button">
...
<div id="chatbot-container">
	<div id="chatbot-header">
		...
		<button id="chatbot-closer">&times;</button>
	</div>
...
<script
	src="${pageContext.request.contextPath}/assets/js/user/chatbot.js"></script>
<script
	src="${pageContext.request.contextPath}/assets/js/user/user-home.js"></script>