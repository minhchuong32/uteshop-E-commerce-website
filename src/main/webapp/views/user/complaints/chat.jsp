...
<div class="container py-5">
    <h4 class="text-center text-primary-custom mb-4">
        <i class="bi bi-chat-dots"></i> Chat với Admin - Khiếu nại #${complaint.complaintId}
    </h4>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <div class="text-start mb-3">
                        <div class="d-inline-block p-2 rounded bg-danger text-white" style="max-width: 70%;">
    ...
    <form method="post" action="${pageContext.request.contextPath}/user/chat/send">
        <input type="hidden" name="complaintId" value="${complaint.complaintId}">
        <div class="input-group">
            <input name="content" type="text" class="form-control" placeholder="Nhập tin nhắn..." required autocomplete="off">
