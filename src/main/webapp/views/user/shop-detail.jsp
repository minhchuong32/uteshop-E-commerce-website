...
<body>
	<div class="container py-4">
		...
		<div id="product" class="bg-white rounded shadow-sm p-3 mb-4">
			...
			<!-- Bộ lọc -->
			<form action="${pageContext.request.contextPath}/user/shop/detail"
				...
				<div class="col-md-3 d-flex gap-2">
					...
					<a
						href="${pageContext.request.contextPath}/user/shop/detail?id=${shop.shopId}"
				...
				<nav aria-label="Page navigation" class="mt-4">
					<ul class="pagination justify-content-center">
						...
						<li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
							...
							href="${pageContext.request.contextPath}/user/shop/detail?page=${currentPage - 1}&id=${shop.shopId}">
								Trước </a>
						</li>
						<!-- Các số trang -->
						<c:forEach var="i" begin="1" end="${totalPages}">
							<li class="page-item ${i == currentPage ? 'active' : ''}"><a
								...
								href="${pageContext.request.contextPath}/user/shop/detail?page=${i}&id=${shop.shopId}">
									${i} </a></li>
						</c:forEach>
						<!-- Nút Next -->
						<li
