		...
		<form id="cartForm"
			...
			<c:forEach var="entry" items="${cartByShop}">
				<div class="card border-0 shadow-sm mb-4 rounded-3">
					<!-- Header tên shop -->
					<div
						class="card-header bg-light fw-bold border-bottom d-flex align-items-center">
						<i class="bi bi-shop me-2 text-primary"></i> ${entry.key.name}
					</div>

					<div class="card-body">
						<c:forEach var="item" items="${entry.value}">
							<div
								class="cart-item d-flex align-items-center justify-content-between py-3 border-bottom">
								<!-- Cột chọn -->
								...
								<div class="me-3">
									<a
										href="${pageContext.request.contextPath}/user/product/detail?id=${item.productVariant.product.productId}">
										<img
								...
								<div class="flex-fill">
									<h6 class="mb-1 fw-semibold">
										<a
											...
											${item.productVariant.product.name} </a>
									</h6>
			...
			<div class="card border-0 shadow-sm mt-4">
				<div
					...
					<div class="fw-semibold text-muted mb-2 mb-md-0">Tổng tiền
						các sản phẩm đã chọn:</div>
					<div class="text-danger fs-5 fw-bold mb-2 mb-md-0" id="total-price">0
						₫</div>
