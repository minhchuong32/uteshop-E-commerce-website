    ...
    <div class="row g-4 align-items-start">
        ...
        <div class="col-md-6">
            ...
            <p class="text-muted mb-1">
                ...
                <a href="${pageContext.request.contextPath}/vendor/shop/detail?id=${product.shop.shopId}">
                    ${product.shop.name}
                </a>
            </p>
            ...
            <div class="mb-2 text-warning">
                ...
                <span class="text-muted">
                    (<fmt:formatNumber value="${product.averageRating}" maxFractionDigits="1"/>/5 
                    từ ${product.reviewsCount} đánh giá)
                </span>
            </div>
            ...
            <!-- Tổng tồn kho -->
            <p><b>Tổng tồn kho:</b> ${totalStock} sản phẩm</p>
        </div>
    </div>
            ...
            <c:when test="${not empty reviews}">
                <c:forEach var="r" items="${reviews}">
                    <div class="border-bottom pb-3 mb-3 d-flex">
                        <img src="${pageContext.request.contextPath}/assets/images${r.user.avatar}"
