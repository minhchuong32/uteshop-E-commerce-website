...
<body class="d-flex flex-column min-vh-100">
				...
				<ul class="nav flex-column flex-grow-1">
					...
					<li class="nav-item mb-1"><a
						...
						href="${pageContext.request.contextPath}/admin/complaints"> <i
							class="bi bi-chat-dots me-2"></i> Quản lý Khiếu nại
					</a></li>
					<li class="nav-item mb-1"><a
					...
					<li class="nav-item mb-1"><a
						class="nav-link ${page=='contacts' ? 'active' : ''}"
						href="${pageContext.request.contextPath}/admin/home?page=contacts">
							<i class="bi bi-telephone me-2"></i> Quản lý Liên hệ
					</a></li>
					<li class="nav-item mb-1"><a
	...
	<c:if test="${page == 'categories'}">
		<script
			src="${pageContext.request.contextPath}/assets/js/admin/category-list.js"
			defer></script>
	</c:if>
	<c:if test="${page == 'complaints'}">
		<script
			src="${pageContext.request.contextPath}/assets/js/admin/complaint-list.js"
			defer></script>
	</c:if>
	<c:if test="${page == 'orders'}">
		<script
			src="${pageContext.request.contextPath}/assets/js/admin/order-list.js"
			defer></script>
	</c:if>
	<c:if test="${page == 'products'}">
		<script
			src="${pageContext.request.contextPath}/assets/js/admin/product-list.js"
			defer></script>
	</c:if>
	<c:if test="${page == 'promotions'}">
		<script
			src="${pageContext.request.contextPath}/assets/js/admin/promotion-list.js"
			defer></script>
	</c:if>
	<c:if test="${page == 'shops'}">
		<script
			src="${pageContext.request.contextPath}/assets/js/admin/shop-list.js"
			defer></script>
	</c:if>
	<c:if test="${page == 'users'}">
		<script
			src="${pageContext.request.contextPath}/assets/js/admin/user-list.js"
			defer></script>
	</c:if>
	<c:if test="${page == 'carriers'}">
		<script
			src="${pageContext.request.contextPath}/assets/js/admin/carrier-list.js"
			defer></script>
	</c:if>
	<c:if test="${page == 'revenue'}">
		<script
			src="${pageContext.request.contextPath}/assets/js/admin/revenue-list.js"
			defer></script>
	</c:if>
	<c:if test="${page == 'contacts'}">
		<script
			src="${pageContext.request.contextPath}/assets/js/admin/contacts-list.js"
			defer></script>
	</c:if>

	<script src="${pageContext.request.contextPath}/assets/js/loading.js"
		defer></script>
