...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #FFFFFF">
            <div class="container">
                <!-- Logo -->
                <a class="navbar-brand d-flex align-items-center w-29px" href="${pageContext.request.contextPath}/">
    ...
    <div class="main-content mt-5 py-4">
        <div class="login-card" style="margin-top: 80px;">
            ...
            <form action="login" method="post">
                ...
                <div class="mb-3">
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" placeholder="Email / Tên đăng nhập" required>
                    </div>
                </div>
                <!-- Password -->
                <div class="mb-3">
            ...
            <div class="mt-4 p-3 bg-light rounded">
                ...
                <small>User: user@example.com / password</small><br>
                <small>Vendor: vendor@example.com / password</small><br>
