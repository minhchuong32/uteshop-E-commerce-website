			...
			<div class="col-md-3 mb-4">
				...
				<div class="d-flex gap-3">
					<a href="https://www.facebook.com/dhspkt.hcmute/?locale=vi_VN" target="_blank"
						class="text-light fs-5 social-link"> <i class="bi bi-facebook"></i>
	...
	transform: scale(1.2);
			...
			<div class="col-md-3 mb-4">
				...
				<ul class="list-unstyled">
					<li><a href="#product"
						class="text-light text-decoration-none">Tất cả sản phẩm</a></li>
					<li><a href="${pageContext.request.contextPath}/web/products?categoryId=1"
						class="text-light text-decoration-none">Laptop</a></li>
					<li><a href="${pageContext.request.contextPath}/web/products?categoryId=2"
						class="text-light text-decoration-none">Điện Thoại</a></li>
					<li><a href="${pageContext.request.contextPath}/web/products?categoryId=3"
			...
			<div class="col-md-3 mb-4">
				...
				<ul class="list-unstyled">
					<li><a href="${pageContext.request.contextPath}/login" class="text-light text-decoration-none">Trung
							tâm trợ giúp</a></li>
					<li><a href="${pageContext.request.contextPath}/login" class="text-light text-decoration-none">Đổi
							trả và Hoàn tiền</a></li>
					<li><a href="${pageContext.request.contextPath}/login" class="text-light text-decoration-none">Thông
							tin vận chuyển</a></li>
					<li><a href="${pageContext.request.contextPath}/web/cart" class="text-light text-decoration-none">Theo
							dõi đơn hàng</a></li>
				</ul>
			</div>
