...
@WebServlet(urlPatterns = { "/vendor/products", "/vendor/products/add", "/vendor/products/edit",
		"/vendor/products/delete", "/vendor/products/detail" })
...
public class ProductController extends HttpServlet {
	...
	private final IProductVariantService variantService = new ProductVariantServiceImpl(); // Renamed for clarity
	private static final int PAGE_SIZE = 6;

	private static final String PROJECT_IMAGE_PATH = "D:\\Java\\LTWeb\\uteshop-E-commerce-website\\src\\main\\webapp\\assets\\images";
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (uri.endsWith("/products")) {
			// ... (Logic for listing products is correct and does not need to change)
			// It correctly uses the 'shop' object obtained above.
			...
			req.setAttribute("list", allProducts); // Send all products, let JSP handle pagination if needed or adjust
													// logic
		...
		// ... (Other doGet cases like /delete and /detail are correct and need no
		// changes)
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// ✅ GET SHOP FROM REQUEST ATTRIBUTE
		Shop shop = (Shop) req.getAttribute("currentShop");

		// ✅ NO NEED to check if shop is null.

		if (uri.endsWith("/add")) {
			// ... (The entire 'add' logic is correct and uses the 'shop' object properly)
			// No changes are needed inside this block.
			try {
				// ... your existing code ...
				Product p = new Product();
				// ...
				p.setShop(shop); // This line now uses the shop from the request
				// ...
				productService.save(p);
				// ... your variant handling code ...
				resp.sendRedirect(req.getContextPath() + "/vendor/products");
			} catch (Exception e) {
				e.printStackTrace();
			...
			// ... (The entire 'edit' logic is correct and uses the 'shop' object properly)
			// No changes are needed inside this block.
			try {
				int id = Integer.parseInt(req.getParameter("id"));
	...
	// ... (Your file handling methods handleFileUpload and saveFile are correct and
	// need no changes)
}
