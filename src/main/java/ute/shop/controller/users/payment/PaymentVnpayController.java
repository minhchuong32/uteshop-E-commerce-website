...
protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    // Adapter đã làm hết rồi, controller chỉ lấy URL và redirect
    String paymentUrl = req.getParameter("url");
    if (paymentUrl == null || paymentUrl.isEmpty()) {
        resp.sendError(HttpServletResponse.SC_BAD_REQUEST, "Thiếu URL thanh toán");
        return;
    }
    resp.sendRedirect(paymentUrl);
}
