...
public class ChatImageUploadServlet extends HttpServlet {
	...
	private static final String UPLOAD_DIR = "assets/uploads/chat-files";
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			String publicUrl = "/" + UPLOAD_DIR.replace("\\", "/") + "/" + fileName;
	...
	private boolean isAllowedFile(String filename) {
		...
		return lowerName.endsWith(".jpg") || lowerName.endsWith(".jpeg") || lowerName.endsWith(".png")
				|| lowerName.endsWith(".gif") || lowerName.endsWith(".pdf") || lowerName.endsWith(".doc")
				|| lowerName.endsWith(".docx") || lowerName.endsWith(".xls") || lowerName.endsWith(".xlsx")
				|| lowerName.endsWith(".txt") || lowerName.endsWith(".ppt") || lowerName.endsWith(".pptx");
	}
}